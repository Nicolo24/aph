            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="province_id" class="col-md-4 col-form-label text-md-end">{{ __('Province') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="zone_id" class="col-md-4 col-form-label text-md-end">{{ __('Zone') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="institution_id" class="col-md-4 col-form-label text-md-end">{{ __('Institution') }}</label>
