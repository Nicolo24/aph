                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('centers.index') }}">{{ __('Centros') }}</a>
                                <a class="dropdown-item" href="{{ route('provinces.index') }}">{{ __('Provincias') }}</a>
                                <a class="dropdown-item" href="{{ route('zones.index') }}">{{ __('Zonas') }}</a>
                                <a class="dropdown-item" href="{{ route('institutions.index') }}">{{ __('Instituciones') }}</a>
